...
struct RwOpenGLVertex
{
    ...
    RwReal sow; /**< Perspective-correct U texture coordinate */
    RwReal tow; /**< Perspective-correct V texture coordinate */

    RwReal row;   /**< Internal use only */
    RwReal oow;   /**< Texture perspective correction */
    RwReal recpz; /**< Reciprocal Z component */
};
